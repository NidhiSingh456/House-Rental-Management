...
<body>
  ...
  <nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top" style="font-size: 22px;'">
    <ul class="navbar-nav">
  <li class="nav-item ">
      <a class="nav-link" href="CustomerHomePage.html">HomePage |</a>
    </li>
    <li class="nav-item ">
      <a class="nav-link" href="AddCustomerProfile.html">AddProfile |</a>
    </li>
    <li class="nav-item ">
      <a class="nav-link" href="GetCustomerProfile.html">View Profile |</a>
    </li>
...
<%
   ...
   PreparedStatement ps = con.prepareStatement("select * from addhouse where loc='"+search+"'");
   ps.execute();
...
<table border="2" style="margin-left:200px; margin-top:30px;margin-bottom:50px; width:800px ;background-color: ivory;"> 
    <tr>
         <td style="text-align:center;"><h2><b> PICTURE :</b></h2> <hr/> <img src="Images/<%= res.getString(8) %>"  alt="Profile Picture" height="300" width="300"/>
               <hr/>
         </td>
